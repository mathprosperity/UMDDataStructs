 ...
 * that is executed more efficiently in ArrayLinearList than in LinkedLinearList is the remove(int)
...
public class StaticArrayList<T> implements List<T> {
	...
	/**
	 * Copy constructor. Makes a deep copy of the parameter LinearList based on the elements
	 * of the current list. Note that the argument is of type LinearList<T>, not just ArrayLinearList:
	 * we can make a copy of any kind of list to our internal representation.
	 * @param list The LinearList to make a copy of.
	 */
	...
	/* removeAll(T) will be similar to remove(T), the main difference being that we
