...
public class LinkedMaxHeapTest {
	...
	private MaxHeap<Integer> intHeap = new LinkedMaxHeap<Integer>();
	private MaxHeap<String> stringHeap = new LinkedMaxHeap<String>();
	...
	public void testCopyConstructorAndEquals(){
		MaxHeap<String> stringHeapCopy = new LinkedMaxHeap<String>(stringHeap);
