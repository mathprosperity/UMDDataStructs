...
/* As mentioned on top of ArrayStackTestCase, I have simply copied and pasted all the previous test
 * cases on this file. The only thing that's changed is the polymorphic calls to the appropriate 
 * constructors in the private data members of the class ArrayListStackTestCase.
 */
...
public class ArrayListStackTest {
	...
	private Stack<String> stringStack = new ArrayListStack<String>();
	private Stack<Integer> integerStack = new ArrayListStack<Integer>();
