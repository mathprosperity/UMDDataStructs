...
import datastructures.queues.LinearArrayQueue;
...
public class CircularArrayQueueTest {
	...
	private Queue<Integer> integerQueue = new CircularArrayQueue<Integer>();
	private Queue<String> stringQueue = new CircularArrayQueue<String>();
	...
	public void testCopyConstructorAndEquals(){
		...
		// Phase 1: Compare equality between queues of the same type.
		...
		// Phase 2: Copy construct a LinearArrayQueue from a CircularArrayQueue.
		Queue<String> linearArrayQueueCopy = new LinearArrayQueue<String>(stringQueue);
		assertEquals(linearArrayQueueCopy, stringQueue);
		
		// Phase 3: Copy construct a LinkedQueue from a CircularArrayQueue.
