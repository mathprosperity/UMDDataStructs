...
import datastructures.symbol_tables.LinearProbingST;
import datastructures.symbol_tables.ST;

public class LinearProbingSTTest {

	private ST<String, String> phonebook = new LinearProbingST<String, String>();
