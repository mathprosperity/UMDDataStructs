...
public class DualArrayOrderedSTTest {

	private final int DEFAULT_CAPACITY = 10;
	private OrderedST<String, String> phonebook = new DualArrayOrderedST<String, String>(DEFAULT_CAPACITY);
	private OrderedST<Integer, String> genericNames = new DualArrayOrderedST<Integer, String>(DEFAULT_CAPACITY);
	...
	@Test
	public void testPutBeyondOriginalCapacity(){
		for(int i = 0; i < 50; i++){
			try{
		...
		assertEquals(genericNames.size(), 50);
	}
	...
	public void testCopyConstructorAndEquals(){
		...
		try {
			copy = new DualArrayOrderedST<Integer, String>(genericNames);
		}catch(Throwable t){
