...
import datastructures.symbol_tables.DualArrayOrderedST;
import datastructures.symbol_tables.OrderedST;
import datastructures.symbol_tables.*;
public class BSTOrderedSTTest {

	private OrderedST<String, String> phonebook = new BSTOrderedST<String, String>();
	private OrderedST<Integer, String> genericNames = new BSTOrderedST<Integer, String>();
	...
	public void testCopyConstructorAndEquals(){
		...
		try {
			copy = new BSTOrderedST<Integer, String>(genericNames);
		}catch(Throwable t){
